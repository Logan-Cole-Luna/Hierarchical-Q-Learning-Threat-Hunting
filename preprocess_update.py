# preprocess_final_with_xgb_fixed.py
...
def split_data(df, label_col='Label', test_size=0.2, random_state=42):
    """
...
def main():
    ...
    train_df, test_df = split_data(df_all, label_col=label_col, test_size=test_size, random_state=random_state)
